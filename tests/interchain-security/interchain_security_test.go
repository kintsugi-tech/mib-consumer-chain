...
import (
	...
	appConsumer "github.com/orionlove-ventures/orion/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and orion consumer chain
